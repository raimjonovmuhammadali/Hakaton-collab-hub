                    ...
                    <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                        <div class="md:w-[316px]">
                            ...
                            <h1 class="text-white font-extrabold">
                                <span class="text-rose-600">COLLAB </span>HUB
                            </h1>
                            </p>
                            <p class="mt-[18px] text-[15px] font-normal text-white/[80%]">Rivojlanib borayotgan yosh zamonaviy soha vakillari uchun o’z ustida ishlash va shu soha bo’yicha o’zini o’zi band qilishni ta’minlash

Start Up va g’oya egalari & Investor tadbirkorlar o’rtasida ko’prik quruvchi platformani yaratish. Shuningdek ushbu jarayon bilan zamonaviy kasb egalari freelancelarni ish bilan taminlash!</p>
                        </div>
                        <div class="md:w-[316px]">
                            <div class="mt-[23px] flex">
                                ...
                                <div class="ml-[18px]">
                                    <a href="tel:+911800123444"
                                        class="font-Inter text-[14px] font-medium text-white">+998 93 000 99 14</a>
                                    <p class="font-Inter text-[12px] font-medium text-white">Bog'lanish</p>
                                </div>
                            </div>
                            <div class="mt-[23px] flex">
                                <div class="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                                ...
                                <div class="ml-[18px]">
                                    <a href="mailto:help@lorem.com"
                                        class="font-Inter text-[14px] font-medium text-[#fff]">collabhub@gmail.com</a>
                                    <p class="font-Inter text-[12px] font-medium text-[#fff]">Email</p>
                                </div>
                            </div>
                            <div class="mt-[23px] flex">
                                <div class="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                                ...
                                <div class="ml-[18px]">
                                    <a href="mailto:help@lorem.com"
                                        class="font-Inter text-[14px] font-medium text-[#fff]">Farg'ona</a>
                                    <p class="font-Inter text-[12px] font-medium text-white">Manzil</p>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="">
                                <p class="text-deutziawhite font-inter text-[18px] font-medium leading-normal">Sahifalar</p>
                                <ul>
                                    <li class="mt-[15px]"><a
                                            class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                                            href="/">Bosh sahifa</a></li>
                                    <li class="mt-[15px]"><a
                                            class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                                            href="/startups">Startuplar</a></li>
                                    <li class="mt-[15px]"><a
                                            class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                                            href="/">Ish o'rinlari</a></li>
                                    <li class="mt-[15px]"><a
                                            class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                                            href="/plans-and-pricing">Biz haqimizda</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
